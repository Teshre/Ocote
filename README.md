...
*The terminal that lights up the black screen. Offline, no AI, built for humans.*
...
<!-- TODO lanzamiento: reemplazar por captura/GIF real de Ocote en acción -->
<!-- ![Ocote demo](docs/assets/demo.gif) -->
