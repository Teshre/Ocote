...
(function () {
  ...
  const STRINGS = {
    es: {
      ...
      'settings.lang.label':    'Idioma de la ayuda',
    ...
    en: {
      ...
      'settings.lang.label':    'Help language',
    ...
    pt: {
      ...
      'settings.close':         '✕',
      'settings.lang.title':    'Idioma',
      'settings.lang.label':    'Idioma da ajuda',
    ...
    fr: {
      ...
      'settings.lang.label':    "Langue de l'aide",
    ...
    de: {
      ...
      'settings.lang.label':    'Hilfssprache',
