...
(function () {
  ...
  const STRINGS = {
    es: {
      ...
      'settings.prompt.git':    'Ocote · Git (ruta + rama)',
      'settings.prompt.minimal':'Ocote · Minimal (flecha + carpeta)',
      'settings.prompt.full':   'Ocote · Completo (usuario, ruta, git, hora)',
      'settings.prompt.custom': 'Personalizado…',
      'settings.prompt.mine':   'Mi configuración (p10k, oh-my-zsh…)',
      'settings.prompt.hint':   'Se aplica al abrir una nueva pestaña.',
      'settings.prompt.editor.preview':   'Vista previa',
      'settings.prompt.editor.style':     'Líneas',
      'settings.prompt.editor.oneline':   'Una línea',
      'settings.prompt.editor.twoline':   'Dos líneas',
      'settings.prompt.editor.show':      'Mostrar',
      'settings.prompt.editor.user':      'usuario@host',
      'settings.prompt.editor.git':       'rama git',
      'settings.prompt.editor.time':      'hora',
      'settings.prompt.editor.pathcolor': 'Color ruta',
      'settings.prompt.editor.gitcolor':  'Color git',
      'settings.prompt.editor.arrowcolor':'Color ❯',
    ...
    en: {
      ...
      'settings.prompt.git':    'Ocote · Git (path + branch)',
      'settings.prompt.minimal':'Ocote · Minimal (arrow + folder)',
      'settings.prompt.full':   'Ocote · Full (user, path, git, time)',
      'settings.prompt.custom': 'Custom…',
      'settings.prompt.mine':   'My config (p10k, oh-my-zsh…)',
      'settings.prompt.hint':   'Applied when opening a new tab.',
      'settings.prompt.editor.preview':   'Preview',
      'settings.prompt.editor.style':     'Lines',
      'settings.prompt.editor.oneline':   'One line',
      'settings.prompt.editor.twoline':   'Two lines',
      'settings.prompt.editor.show':      'Show',
      'settings.prompt.editor.user':      'user@host',
      'settings.prompt.editor.git':       'git branch',
      'settings.prompt.editor.time':      'time',
      'settings.prompt.editor.pathcolor': 'Path color',
      'settings.prompt.editor.gitcolor':  'Git color',
      'settings.prompt.editor.arrowcolor':'❯ color',
    ...
    pt: {
      ...
      'settings.prompt.git':    'Ocote · Git (caminho + branch)',
      'settings.prompt.minimal':'Ocote · Minimal (seta + pasta)',
      'settings.prompt.full':   'Ocote · Completo (usuário, caminho, git, hora)',
      'settings.prompt.custom': 'Personalizado…',
      'settings.prompt.mine':   'Minha configuração (p10k, oh-my-zsh…)',
      'settings.prompt.hint':   'Aplicado ao abrir uma nova aba.',
      'settings.prompt.editor.preview':   'Pré-visualização',
      'settings.prompt.editor.style':     'Linhas',
      'settings.prompt.editor.oneline':   'Uma linha',
      'settings.prompt.editor.twoline':   'Duas linhas',
      'settings.prompt.editor.show':      'Mostrar',
      'settings.prompt.editor.user':      'usuário@host',
      'settings.prompt.editor.git':       'branch git',
      'settings.prompt.editor.time':      'hora',
      'settings.prompt.editor.pathcolor': 'Cor do caminho',
      'settings.prompt.editor.gitcolor':  'Cor git',
      'settings.prompt.editor.arrowcolor':'Cor ❯',
    ...
    fr: {
      ...
      'settings.prompt.git':    'Ocote · Git (chemin + branche)',
      'settings.prompt.minimal':'Ocote · Minimal (flèche + dossier)',
      'settings.prompt.full':   'Ocote · Complet (utilisateur, chemin, git, heure)',
      'settings.prompt.custom': 'Personnalisé…',
      'settings.prompt.mine':   'Ma configuration (p10k, oh-my-zsh…)',
      'settings.prompt.hint':   "Appliqué à l'ouverture d'un nouvel onglet.",
      'settings.prompt.editor.preview':   'Aperçu',
      'settings.prompt.editor.style':     'Lignes',
      'settings.prompt.editor.oneline':   'Une ligne',
      'settings.prompt.editor.twoline':   'Deux lignes',
      'settings.prompt.editor.show':      'Afficher',
      'settings.prompt.editor.user':      'utilisateur@host',
      'settings.prompt.editor.git':       'branche git',
      'settings.prompt.editor.time':      'heure',
      'settings.prompt.editor.pathcolor': 'Couleur chemin',
      'settings.prompt.editor.gitcolor':  'Couleur git',
      'settings.prompt.editor.arrowcolor':'Couleur ❯',
    ...
    de: {
      ...
      'settings.prompt.git':    'Ocote · Git (Pfad + Branch)',
      'settings.prompt.minimal':'Ocote · Minimal (Pfeil + Ordner)',
      'settings.prompt.full':   'Ocote · Vollständig (Benutzer, Pfad, Git, Zeit)',
      'settings.prompt.custom': 'Benutzerdefiniert…',
      'settings.prompt.mine':   'Meine Konfiguration (p10k, oh-my-zsh…)',
      'settings.prompt.hint':   'Wird beim Öffnen eines neuen Tabs angewendet.',
      'settings.prompt.editor.preview':   'Vorschau',
      'settings.prompt.editor.style':     'Zeilen',
      'settings.prompt.editor.oneline':   'Eine Zeile',
      'settings.prompt.editor.twoline':   'Zwei Zeilen',
      'settings.prompt.editor.show':      'Anzeigen',
      'settings.prompt.editor.user':      'Benutzer@Host',
      'settings.prompt.editor.git':       'Git-Branch',
      'settings.prompt.editor.time':      'Zeit',
      'settings.prompt.editor.pathcolor': 'Pfadfarbe',
      'settings.prompt.editor.gitcolor':  'Git-Farbe',
      'settings.prompt.editor.arrowcolor':'❯-Farbe',
